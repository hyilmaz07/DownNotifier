...
(function (f) {
    ...
    function x(a, b, d) {
        ...
        if (!0 !== c[b]) {
            ...
            } u ? (c[b] = !0, c[k] && q(a, k, "force")) : (d || (c[b] = !0)
    ...
    function q(a, b, d) {
        ...
        g[_remove](r || l(a, b) || "");
        g.attr("role") && !f && g.attr("aria-" + (m ? n : k)
            , "false");
        g[_add](q || l(a, s) || "")
    }
    function E(a, b) {
    ...
    f.fn[m] = function (a, b) {
        ...
        var e = f.extend({
            checkedClass: k
            , disabledClass: n
            , indeterminateClass: _indeterminate, labelHover: !0
        }, a)
            , l = e.handle
        ...
        return c.each(function () {
            ...
            var c = this,
                ...
                , u = !!e.aria, y = m + "-" + Math.random().toString(36).substr(2, 6)
